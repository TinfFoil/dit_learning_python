...
\alert{\textit{3rd} year}

\textbf{Paolo Gajo} 

Gastronomy research through LLMs				\pause 

\begin{itemize}
 \item Internship at Dalhousie University (Halifax, Canada)
 \item 6+ peer-reviewed full papers published (incl.\, Neurips and IPM)
 \item Represented RER at the Osaka World Expo 2025
\end{itemize}
\bigskip					\pause  

\alert{\textit{1st} year}

\textbf{Debora Ciminari}

Idiom identification and processing
\medskip 			\pause 

\textbf{Donatella Laperchia}
...
\begin{frame}
\frametitle{PhDs that I've supervised}

\alert{2024}

\textbf{Arianna Muti} (Universit\`a Milano-Bocconi, Italy)
...
\begin{itemize}
 ...
 \item 12+ peer-reviewed full papers published (incl.\, one at EMNLP)
 \item Won a competition on hate speech identification
\end{itemize}
\medskip 					\pause 


\textbf{Katerina Korre} (Archimedes Research Hub, Greece)
...
\begin{itemize}
 ...
 \item 10+ peer-reviewed full papers published (incl.\, LRE)
\end{itemize}
\end{frame}

\begin{frame}
\frametitle{PhDs that I have followed}

\alert{2024}

\textbf{Marco Casavantes} (co-supervision)

Multidimensional Analysis of Text for Automated Detection of Computational 
Propaganda in Twitter 
\bigskip 

\textbf{Francisco J\'a\~nez Martino} (visiting; Smarkia, Spain)

Analysis of phishing and spam email (cybersecurity)
\bigskip 	\pause

\alert{Unfinished}

\textbf{Francesco Fernicola} (CL at the European Parliament)
...
\item \alert{Giara} on DL and LLMs for gastronomy explanation
 \light{\url{https://progettogiara.it}}
\bigskip	\pause 
...
\pause
 \item Is an approximate solution enough?	\pause
...
If I have an exam, I will ride to the university earlier than usual	\\	\pause
